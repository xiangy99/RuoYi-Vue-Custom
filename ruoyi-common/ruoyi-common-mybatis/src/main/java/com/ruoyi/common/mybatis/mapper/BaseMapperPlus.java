...
public interface BaseMapperPlus<T, V> extends BaseMapper<T> {
     ...
     * @return 查询到的单个VO对象
     */
    default V getVo(Serializable id) {
        return getVo(id, this.currentVoClass());
    }
     ...
     */
    default <C> C getVo(Serializable id, Class<C> voClass) {
     ...
     * @return 查询到的VO对象列表
     */
    default List<V> listVoByIdList(Collection<? extends Serializable> idList) {
        return listVoByIdList(idList, this.currentVoClass());
    }
     ...
     */
    default <C> List<C> listVoByIdList(Collection<? extends Serializable> idList, Class<C> voClass) {
     ...
     * @return 查询到的VO对象列表
     */
    default List<V> listVoByMap(Map<String, Object> map) {
        return listVoByMap(map, this.currentVoClass());
    }
     ...
     * @return 查询到的VO对象列表，经过转换为指定的VO类后返回
     */
    default <C> List<C> listVoByMap(Map<String, Object> map, Class<C> voClass) {
     ...
     * @return 查询到的单个VO对象
     */
    default V getVoOne(Wrapper<T> wrapper) {
        return getVoOne(wrapper, this.currentVoClass());
    }
     ...
     * @return 查询到的单个VO对象
     */
    default V getVoOne(Wrapper<T> wrapper, boolean throwEx) {
        return getVoOne(wrapper, this.currentVoClass(), throwEx);
    }
     ...
     */
    default <C> C getVoOne(Wrapper<T> wrapper, Class<C> voClass) {
        return getVoOne(wrapper, voClass, true);
    }
     ...
     * @return 查询到的单个VO对象，经过转换为指定的VO类后返回
     */
    default <C> C getVoOne(Wrapper<T> wrapper, Class<C> voClass, boolean throwEx) {
    ...
    default List<V> listVo() {
        return listVo(new QueryWrapper<>(), this.currentVoClass());
    }
     ...
     * @return 查询到的VO对象列表
     */
    default List<V> listVo(Wrapper<T> wrapper) {
        return listVo(wrapper, this.currentVoClass());
    }
     ...
     * @return 查询到的VO对象列表，经过转换为指定的VO类后返回
     */
    default <C> List<C> listVo(Wrapper<T> wrapper, Class<C> voClass) {
